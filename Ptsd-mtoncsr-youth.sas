...
libname mto '/home/sampson/MTO100410/youth';
libname LIBRARY '/home/sampson/MTO100410/youth';
...
set mto.mental_health_yt_20101004;
format _numeric_;
%include '/home/jin/MTO/YOUTH/DIAGNOSIS/Datafix2-mto-youth.sas';
%include '/home/jin/MTO/YOUTH/DIAGNOSIS/agefix-youth.sas';
run;
...
idvar age sexf rhisp rblk roth PT41 PT42 PT43 PT44 PT45 PT46 PT48 PT50 PT50_1 PT51 PT55
      ...
      mto_ptsd_sample mto_youth YCV13_PT62 YCV14_PT64 YCV14a YCV14b_PT64a YCV14c 
      YCV22_PT261;
...
set pred1(where = (mto_youth = 1));
length ppid $10.;
ppid = input(ppid_num, 15.);
if mto_youth = 1 then output pred_ptsd_youth;
run;

data mtomp.fnlpred_ptsd_youth(keep = ppid f_mh_pts_evr_yt f_mh_pts_aoo_yt f_mh_pts_rec_yt);
set pred_ptsd_youth;
...
proc freq data = mtomp.fnlpred_ptsd_youth;
title 'Youth PTSD, new diagnosis lifetime and 12 month';
